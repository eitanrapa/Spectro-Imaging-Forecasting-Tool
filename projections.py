...
def differential_intensity_projection(y_value, electron_temperature, peculiar_velocity, sides_long, sides_lat, bands,
    ...
    plt.xticks(np.rint(np.logspace(np.log10(80), np.log10(1e3), num=9)),
               np.rint(np.logspace(np.log10(80), np.log10(1e3), num=9)))
...
def contour_plot_double_projection(run_number1, run_number2, y_value, electron_temperature, peculiar_velocity,
                                   a_sides=1, b_sides=1):
    """
